...
public enum PostExceptionEnum implements ExceptionCode{
    ...
    POST_UNABLE_TO_TITLE4(HttpStatus.INTERNAL_SERVER_ERROR, "POST_009", "제목을 입력해주세요"),
    POST_UNABLE_TO_ContentsNULLPOINT(HttpStatus.INTERNAL_SERVER_ERROR, "POST_A010", "내용을 입력해주세요"),
