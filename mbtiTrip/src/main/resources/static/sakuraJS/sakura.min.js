...
var Sakura=function(t,e){
	var c=this;if(void 0===t)throw new Error("No selector present. Define an element.");
	this.el=document.querySelector(t);
	var a,n;function d(t){
		...
		function m(t,e){
			...
			this.settings=(a={
				className:"sakura",fallSpeed:1,maxSize:14,minSize:10,delay:300,colors:[{
					...
					gradientColorDegree:120}]
						...
						function u(t,e,a){for(var n=0;n<o.length;n+=1){
							var i=e;o[n]||(i=e.toLowerCase()),t.addEventListener(o[n]+i,a,!1)}}function h(t){
